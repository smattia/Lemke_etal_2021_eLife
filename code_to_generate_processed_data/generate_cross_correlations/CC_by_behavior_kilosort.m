function [all_pairs] = CC_by_behavior_kilosort(pre_m1_spiking, pre_dls_spiking, post_m1_spiking, post_dls_spiking, pre_beh_state, post_beh_state, pre_video_start_stop, post_video_start_stop)
    %   
...
%                                 end
%                             end
%                             pre_cc_nrem = [pre_cc_nrem; tmp_pre_cc_nrem nan(1,100-length(tmp_pre_cc_nrem))];
%                         end
...
%                                 end
%                             end
%                             pre_cc_rem = [pre_cc_rem; tmp_pre_cc_rem nan(1,100-length(tmp_pre_cc_rem))];
%                         end
...
%                                 end
%                             end
%                             pre_cc_wake = [pre_cc_wake; tmp_pre_cc_wake nan(1,100-length(tmp_pre_cc_wake))];
%                         end
...
%                                 end
%                             end
%                             post_cc_nrem = [post_cc_nrem; tmp_post_cc_nrem nan(1,100-length(tmp_post_cc_nrem))];
%                         end
...
%                                 end
%                             end
%                             post_cc_rem = [post_cc_rem; tmp_post_cc_rem nan(1,100-length(tmp_post_cc_rem))];
%                         end
...
%                                 end
%                             end
%                             post_cc_wake = [post_cc_wake; tmp_post_cc_wake nan(1,100-length(tmp_post_cc_wake))];
%                         end
