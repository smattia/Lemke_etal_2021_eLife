...
for day = 1:8
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\T102\cross_correlations\day_' num2str(day) '\jitter_test_behavior_state_cc.mat']);
        sig = [all_pairs.jitter_sig];
        
        [all_pairs] = spindle_CC_before_after(pre_m1_spiking, pre_dls_spiking, post_m1_spiking, post_dls_spiking, pre_video_start_stop, post_video_start_stop,pre_sleep_rhythms,post_sleep_rhythms,sig);
   ...
   %%% SAVE
       ...
       save('spindle_cc_before_after.mat','all_pairs','-v7.3');
...
for day = 1:6
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\T107\cross_correlations\day_' num2str(day) '\jitter_test_behavior_state_cc.mat']);
        sig = [all_pairs.jitter_sig];
...
for day = [2 3 4 7:10]
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\T200\cross_correlations\day_' num2str(day) '\jitter_test_behavior_state_cc.mat']);
        sig = [all_pairs.jitter_sig];
...
for day = 3:17
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\T201\cross_correlations\day_' num2str(day) '\jitter_test_behavior_state_cc.mat']);
        sig = [all_pairs.jitter_sig];
...
for day = [4:13]
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\SLDD2\cross_correlations\day_' num2str(day) '\jitter_test_behavior_state_cc.mat']);
        sig = [all_pairs.jitter_sig];
...
for day = [1:9]
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\T398\cross_correlations\day_' num2str(day) '\jitter_test_behavior_state_cc.mat']);
        sig = [all_pairs.jitter_sig];
