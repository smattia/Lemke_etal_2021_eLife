...
for day = 1:8
    ...
    %%% LOAD SPIKING DATA
        ...
        [all_pairs] = jitter_NREM_rhythm(pre_m1_spiking, pre_dls_spiking, post_m1_spiking, post_dls_spiking, pre_video_start_stop, post_video_start_stop,pre_sleep_rhythms,post_sleep_rhythms,sig);
   ...
   %%% SAVE
       ...
       save('NREM_rhythms_cc.mat','all_pairs','-v7.3');
