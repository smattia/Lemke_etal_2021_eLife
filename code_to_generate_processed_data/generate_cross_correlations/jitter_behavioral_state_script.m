...
for day = 1:8
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\T102\cross_correlations\day_' num2str(day) '\jitter_test.mat']);
        sig = [all_pairs.p_val];
        
        [all_pairs] = jitter_behavioral_state(pre_m1_spiking, pre_dls_spiking, post_m1_spiking, post_dls_spiking, pre_beh_state, post_beh_state, pre_video_start_stop, post_video_start_stop,sig);
   ...
   %%% SAVE
       ...
       save('behavioral_state_cc.mat','all_pairs','-v7.3');
...
for day = 1:6
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\T107\cross_correlations\day_' num2str(day) '\jitter_test.mat']);
        sig = [all_pairs.p_val];
...
for day = 2:10
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\T200\cross_correlations\day_' num2str(day) '\jitter_test.mat']);
        sig = [all_pairs.p_val];
...
for day = 3:17
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\T201\cross_correlations\day_' num2str(day) '\jitter_test.mat']);
        sig = [all_pairs.p_val];
...
for day = [4:13]
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\SLDD2\cross_correlations\day_' num2str(day) '\jitter_test.mat']);
        sig = [all_pairs.p_val];
...
for day = [1:9]
    ...
    %%% LOAD SPIKING DATA
        ...
        load(['C:\Users\Stefan\Desktop\Lemke_etal_2021\data\T398\cross_correlations\day_' num2str(day) '\jitter_test.mat']);
        sig = [all_pairs.p_val];
