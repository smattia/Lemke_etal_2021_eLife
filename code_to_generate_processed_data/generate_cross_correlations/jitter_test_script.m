...
for day = 1:8
    ...
    %%% LOAD SPIKING DATA
        ...
        [all_pairs] = jitter_test(pre_m1_spiking, pre_dls_spiking, post_m1_spiking, post_dls_spiking, pre_beh_state, post_beh_state, pre_video_start_stop, post_video_start_stop);
   ...
   %%% SAVE
       ...
       save('jitter_test.mat','all_pairs','-v7.3');
...
for day = 2:10
   ...
   %%% SAVE
       ...
       cd([save_path '\day_' num2str(day) '\']);
       save('jitter_test_25.mat','all_pairs','-v7.3'); 
       close all;
